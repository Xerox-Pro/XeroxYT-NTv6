...
- **公式プロジェクト**: **Wista API Project**
- **edu key 取得元URL**: `https://raw.githubusercontent.com/wista-api-project/auto/refs/heads/main/edu/1.txt`

本ソフトウェアは、Wista API License V1 の規定に基づき、原作者である **woolisbest** のクレジットを明示して運用・公開されています。
